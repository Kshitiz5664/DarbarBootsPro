...
urlpatterns = [
    ...
    # ============================
     ...
     path('returns/<int:return_id>/', views.ReturnDetailView.as_view(), name='return_detail'),
     ...
     path(
          'ajax/invoice/<int:invoice_id>/returnable-items/',
          views.get_invoice_items_for_return,
          name='get_invoice_items_for_return'
     ),
     path(
          'ajax/return/calculate-amount/',
          views.calculate_return_amount,
          name='calculate_return_amount'
     ),
     path(
          'ajax/return/validate-items/',
          views.validate_return_items,
          name='validate_return_items'
     ),
     
     path('ajax/invoice/<int:invoice_id>/returnable-items/', 
         views.get_invoice_items_for_return, 
         name='ajax_invoice_returnable_items'),
     # ✅ ADD THIS LINE
